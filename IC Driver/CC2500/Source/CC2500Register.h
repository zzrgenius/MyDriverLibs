#ifndef __CC2500_REGISTER_H__
#define __CC2500_REGISTER_H__
 ...
 * 模块级变量声明                                      *
 *----------------------------------------------*/
const CC2500_REG tab_CC2500Register[] =
{
    ...
    {TI_CCxxx0_FREQ1, 0x58},// Frequency control word, middle byte.
    {TI_CCxxx0_FREQ0, 0x9D},// Frequency control word, low byte.        
    {TI_CCxxx0_MDMCFG4, 0x2D},// Modem configuration.
    {TI_CCxxx0_MDMCFG3, 0x3B},// Modem configuration. 
    {TI_CCxxx0_MDMCFG2, 0x73},// Modem configuration.   //2-fsk
    // Disables Manchester encoding/decoding.
    {TI_CCxxx0_MDMCFG1, 0x23},// Modem configuration.  333.33KHz 
    {TI_CCxxx0_MDMCFG0, 0xa4},// Modem configuration.
//    {TI_CCxxx0_CHANNR, rf_channel},// Channel number.
    {TI_CCxxx0_DEVIATN, 0x00},// Modem deviation setting {when FSK modulation is enabled}.
    {TI_CCxxx0_FREND1, 0xB6},// Front end RX configuration.
    {TI_CCxxx0_FREND0, 0x10},// Front end TX configuration.
    {TI_CCxxx0_MCSM1, 0x30},//
    {TI_CCxxx0_MCSM0, 0x08},//0X18 Never {manually calibrate using SCAL strobe}
    ...
    {TI_CCxxx0_FSCAL2, 0x0A},// Frequency synthesizer calibration.
    ...
    {TI_CCxxx0_IOCFG2, 0x06},//Asserts when sync word has been sent / received, and de-asserts at the end of the packet. 
    {TI_CCxxx0_IOCFG0, 0x06},//In RX, the pin will de-assert when the optional address check fails or the RX FIFO overflows.
    {TI_CCxxx0_IOCFG1, 0x06},//In TX the pin will de-assert if the TX FIFO underflows.
    {TI_CCxxx0_PKTCTRL1, 0x04},//Packet Automation Control No address check
    {TI_CCxxx0_PKTCTRL0, 0x45},//Packet Automation Control
    ...
    {TI_CCxxx0_ADDR, 0x00},
    {TI_CCxxx0_PKTLEN, 0xFF},
    {TI_CCxxx0_PATABLE, 0xFF}   
};

#define CC2500_REG_SIZE (sizeof(tab_CC2500Register)/sizeof(tab_CC2500Register[0]))
/*----------------------------------------------*
 * 模块级函数声明                                      *
 *----------------------------------------------*/


#endif /* __CC2500_REGISTER_H__ */
