...
typedef struct
{
	...
	uchar nCC2500ErrFlag : 1;//≥ı ºªØ±®¥Ì
}CC2500_INF;
VAR_CC2500_EXT CC2500_INF Cc2500Inf;

VAR_CC2500_EXT void f_Delay(uint rTime);
...
VAR_CC2500_EXT void f_ResetInit(void);
VAR_CC2500_EXT void f_SleepCC2500(void);
