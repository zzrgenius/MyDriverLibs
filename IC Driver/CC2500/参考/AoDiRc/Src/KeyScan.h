...
VAR_KEY_SCAN_EXT FLASH ulong nTab_KeyHexDef[]
#ifdef VAR_KEY_SCAN_GLOBALS
=
{
	KEY_COM_1,
...
//VAR_KEY_SCAN_EXT KEY_SCAN_INF KeyScanInf __attribute__((at(0x0a0)));
VAR_KEY_SCAN_EXT KEY_SCAN_INF KeyScanInf;

VAR_KEY_SCAN_EXT void f_pKeyScan(void);
