...
VAR_MAIN_EXT AT_NEAR TYPE_WORD nTime_Flag;
...
VAR_MAIN_EXT AT_NEAR unsigned char n50msCnt; 
VAR_MAIN_EXT AT_NEAR unsigned char n1sCnt;

VAR_MAIN_EXT AT_NEAR uchar nPowerOnTm;				//开机计时器
VAR_MAIN_EXT AT_NEAR uchar nKeyWakeTm;					//按键唤醒时间
VAR_MAIN_EXT AT_NEAR uchar nLowPowerCnt;			//低电压计数
VAR_MAIN_EXT AT_NEAR uchar ADDR[3];
...
VAR_MAIN_EXT void f_CalTm(void);	
VAR_MAIN_EXT void f_Go_To_Halt(void);
