...
VAR_UART1_EXT void f_Uart1_init(uint baudRate);
VAR_UART1_EXT void f_Uart1SendDeal(BIG_STRUCT *pFuctionData);
VAR_UART1_EXT void f_Uart1ReceDeal(BIG_STRUCT *pFuctionData);
VAR_UART1_EXT void f_Uart1TimeCnt(void);
